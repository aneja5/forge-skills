...
| `/feedback` | Cross-cutting | `feedback` | one upstream artifact + a downstream finding | `.forge/feedback/<ts>-<source>.md` |
...
│   └── feedback/                    # Reverse-cascade entries (downstream → upstream)
